 ...
 */
final class Version20210816121412 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__major_version AS SELECT version, title, subtitle, description, release_date, lts, maintained_until, elts_until FROM major_version');
        ...
        , PRIMARY KEY(version))');
        $this->addSql('INSERT INTO major_version (version, title, subtitle, description, release_date, lts, maintained_until, elts_until) SELECT version, title, subtitle, description, release_date, lts, maintained_until, elts_until FROM __temp__major_version');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , elts_until DATETIME DEFAULT \'NULL --(DC2Type:datetime_immutable)\' --(DC2Type:datetime_immutable)
        , PRIMARY KEY(version))');
