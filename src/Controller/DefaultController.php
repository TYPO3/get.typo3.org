...
class DefaultController extends Controller
{
	...
	public function composerHelper(Request $request): Response
	{
		...
		return $this->render($templateName, ['form' => $form->createView(), 'formData' => []]);
	}
	/**
	 * @Route("/ajax/composer/helper/generate", methods={"POST"}, name="ajax-composer-helper-generate")
	 */
	public function composerHelperAjax(Request $request): Response
	{
		$formBuilder = $this->createFormBuilder();
		...
		return new JsonResponse(array('status' => $formData));
	}
