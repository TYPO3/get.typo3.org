...
final class ComposerPackagesService
{
    ...
    private const PACKAGES = [
        ...
        [
            ...
            'description' => 'TYPO3 Theme: "Camino" - The default theme for TYPO3 sites in the TYPO3 v14 series.',
            'versions' => [
                14,
            ],
        ],
    ...
    /**
     * Maps bundle names to their packages. Values are either true (always included)
     * or an array of major version integers (only included for those versions).
     *
     * @var array<string, array<string, true|int[]>>
     */
    private const BUNDLES = [
        'typo3/full'      => [
            'typo3/cms-about'               => true,
            'typo3/cms-adminpanel'          => true,
            'typo3/cms-backend'             => true,
            'typo3/cms-belog'               => true,
            'typo3/cms-beuser'              => true,
            'typo3/cms-context-help'        => true,
            'typo3/cms-core'                => true,
            'typo3/cms-cshmanual'           => true,
            'typo3/cms-css-styled-content'  => true,
            'typo3/cms-documentation'       => true,
            'typo3/cms-dashboard'           => true,
            'typo3/cms-extbase'             => true,
            'typo3/cms-extensionmanager'    => true,
            'typo3/cms-feedit'              => true,
            'typo3/cms-felogin'             => true,
            'typo3/cms-filelist'            => true,
            'typo3/cms-filemetadata'        => true,
            'typo3/cms-fluid'               => true,
            'typo3/cms-fluid-styled-content' => true,
            'typo3/cms-form'                => true,
            'typo3/cms-frontend'            => true,
            'typo3/cms-func'                => true,
            'typo3/cms-impexp'              => true,
            'typo3/cms-indexed-search'      => true,
            'typo3/cms-info'                => true,
            'typo3/cms-info-pagetsconfig'   => true,
            'typo3/cms-install'             => true,
            'typo3/cms-lang'                => true,
            'typo3/cms-linkvalidator'       => true,
            'typo3/cms-lowlevel'            => true,
            'typo3/cms-opendocs'            => true,
            'typo3/cms-reactions'           => true,
            'typo3/cms-recordlist'          => true,
            'typo3/cms-recycler'            => true,
            'typo3/cms-redirects'           => true,
            'typo3/cms-reports'             => true,
            'typo3/cms-rsaauth'             => true,
            'typo3/cms-rte-ckeditor'        => true,
            'typo3/cms-saltedpasswords'     => true,
            'typo3/cms-scheduler'           => true,
            'typo3/cms-seo'                 => true,
            'typo3/cms-setup'               => true,
            'typo3/cms-sv'                  => true,
            'typo3/cms-sys-action'          => true,
            'typo3/cms-sys-note'            => true,
            'typo3/cms-t3editor'            => true,
            'typo3/cms-taskcenter'          => true,
            'typo3/cms-tstemplate'          => true,
            'typo3/cms-version'             => true,
            'typo3/cms-viewpage'            => true,
            'typo3/cms-webhooks'            => true,
            'typo3/cms-wizard-crpages'      => true,
            'typo3/cms-wizard-sortpages'    => true,
            'typo3/cms-workspaces'          => true,
            'typo3/minimal'                 => true,
            'typo3/theme-camino'            => true,
        ],
        'typo3/minimal'   => [
            'typo3/cms-backend'             => true,
            'typo3/cms-core'                => true,
            'typo3/cms-extbase'             => true,
            'typo3/cms-extensionmanager'    => [8, 9, 10, 11, 12],
            'typo3/cms-filelist'            => true,
            'typo3/cms-fluid'               => true,
            'typo3/cms-frontend'            => true,
            'typo3/cms-install'             => [8, 9, 10, 11, 12],
            'typo3/cms-recordlist'          => true,
            'typo3/minimal'                 => true,
        ],
        'typo3/default'   => [
    ...
    public function getBundles(): array
    {
        ...
        foreach (self::BUNDLES as $bundleName => $packages) {
            ...
            foreach ($packages as $packageName => $constraint) {
                ...
                $bundleData[$sanitizedName] = $constraint === true ? null : $constraint;
            }
            $sanitizedBundles[$bundleName] = Utils::jsonEncode($bundleData);
        }
